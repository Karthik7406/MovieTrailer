...
class MovieDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['related_movies'] = Movie.objects.filter(category=self.get_object().category)#.order_by('created')
        return context
...
# creating a view for retrieving information
